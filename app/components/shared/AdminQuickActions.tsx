...
export default function AdminQuickActions({ admin }: AdminQuickActionsProps) {
  ...
  return (
    <>
      <div className=" col-span-2 grid  grid-cols-2 gap-3 text-xs sm:text-sm">
        <button
          onClick={() => setIsAddDonorModalOpen(true)}
          className="w-full h-full flex items-center justify-center gap-2 bg-blue-600 hover:bg-blue-700 text-white font-semibold px-3 py-2 rounded-md sm:rounded-lg transition-all duration-200 shadow-sm hover:shadow-md transform hover:-translate-y-0.5"
        >
        ...
        <button
          ...
          className="w-full h-full flex items-center justify-center gap-2 bg-green-600 hover:bg-green-700 text-white font-semibold px-3 py-2 rounded-md sm:rounded-lg transition-all duration-200 shadow-sm hover:shadow-md transform hover:-translate-y-0.5"
        >
